...
Cyberpunk-terminal-style personal profile page. Static frontend with three
effect modules offloaded to WASM (Rust + C++), a GPU shader background
(Three.js), and a small Go backend for the view counter.
